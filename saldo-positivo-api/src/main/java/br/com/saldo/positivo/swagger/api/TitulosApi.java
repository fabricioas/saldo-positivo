...
public interface TitulosApi {
	...
	default ResponseEntity<Void> deleteLancamentosTitulo(
		...
		if (getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
			...
			log.warn(
					"ObjectMapper or HttpServletRequest not configured in default TitulosApi interface so no example is generated");
		}
	...
	default ResponseEntity<List<LancamentoMes>> lancamentosTitulo(
			@ApiParam(value = "", required = true) @PathVariable("tipo") Integer tipo,
	...
	default ResponseEntity<Void> putLancamentosTitulo(
